...
how a Reality inbound is assembled, and how Reality connection information is
...
- optional protocol-neutral connection information.
...
connection/share information. Application orchestration does not branch on
protocol kind.
...
- Private server material never appears in connection information.
...
- Reality and Shadowsocks are the first two handlers, making the seam real.
